...
from storage import record_problem, init_db, get_all_subscribers
...
def daily_job():
    ...
    try:
        ...
        success = send_email(subject, body, subscribers)
...
def main():
    ...
    # Check if we should only run once (e.g., in GitHub Actions)
