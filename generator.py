...
def get_openrouter_solution(problem_title, problem_content, difficulty):
    ...
    You MUST include line-by-line short explanations as inline comments (e.g. `# iterating array`) within the code.
    After the code block, provide a concise but accurate and understandable explanation of the approach logic, followed by the time and space complexity.
    ...
    Return only the python code block, the approach logic, and the complexity explanation.
    """
